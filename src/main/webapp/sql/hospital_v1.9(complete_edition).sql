...
INSERT INTO `doctor_state` (`Doctor_state_id`, `Doctor_id`, `Date`, `Fee`, `Num`) VALUES
	(2, 3, '2024-06-30', 40, 7),
	(3, 4, '2024-06-30', 40, 20),
	(4, 5, '2024-06-30', 20, 20),
	(5, 6, '2024-06-30', 10, 20),
	(6, 1, '2024-06-30', 40, 5),
	(7, 2, '2024-06-30', 20, 19),
	(8, 1, '2024-07-01', 40, 20),
	(9, 2, '2024-07-01', 20, 20),
	(10, 3, '2024-07-01', 40, 20),
	(11, 4, '2024-07-01', 40, 20),
	(12, 5, '2024-07-01', 20, 20),
	(13, 6, '2024-07-01', 10, 20),
	(14, 1, '2024-07-02', 40, 30),
	(15, 2, '2024-07-02', 20, 19),
	(16, 3, '2024-07-02', 40, 20),
	(17, 4, '2024-07-02', 40, 20),
	(18, 5, '2024-07-02', 20, 20),
	(19, 6, '2024-07-02', 10, 20),
	(20, 1, '2024-07-03', 40, 19),
	(21, 2, '2024-07-03', 20, 20),
	(22, 3, '2024-07-03', 40, 19),
	(23, 4, '2024-07-03', 40, 20),
	(24, 5, '2024-07-03', 20, 20),
	(25, 6, '2024-07-03', 10, 19),
	(26, 1, '2024-07-04', 40, 19),
	(27, 2, '2024-07-04', 20, 20),
	(28, 3, '2024-07-04', 40, 20),
	(29, 4, '2024-07-04', 40, 20),
	(30, 5, '2024-07-04', 20, 19),
	(31, 6, '2024-07-04', 10, 20),
	(32, 1, '2024-07-05', 40, 18);
...
INSERT INTO `treat` (`Treat_id`, `Patient_id`, `Doctor_id`, `Treat_dateTime`, `symptom`, `Diagnose_info`) VALUES
	(16, 1, 3, '2024-07-01 15:56:01', '咳嗽，流鼻涕', '流行性感冒'),
	(17, 1, 3, '2024-07-01 16:02:20', '', ''),
	(19, 1, 3, '2024-07-01 16:21:23', 'test2', 'test2'),
	(20, 1, 3, '2024-07-01 22:28:14', '咳嗽', '感冒'),
	(21, 1, 1, '2024-07-02 21:17:26', '咳嗽，乏力，流清鼻涕', '风寒感冒'),
	(22, 15, 1, '2024-07-02 21:21:03', '', '');
...
INSERT INTO `getdrug` (`Get_id`, `Drug_id`, `Drug_num`, `Get_time`, `Treat_id`) VALUES
	(39, 1, 3, '2024-07-01 15:56:01', 16),
	(40, 1, 3, '2024-07-01 15:56:01', 16),
	(41, 2, 4, '2024-07-01 16:02:20', 17),
	(42, 4, 1, '2024-07-01 16:02:20', 17),
	(50, 2, 2, '2024-07-01 16:21:23', 19),
	(51, 1, 1, '2024-07-01 16:21:23', 19),
	(52, 9, 1, '2024-07-01 16:21:23', 19),
	(53, 5, 1, '2024-07-01 16:21:23', 19),
	(54, 1, 2, '2024-07-01 22:28:14', 20),
	(55, 1, 2, '2024-07-02 21:17:26', 21);
